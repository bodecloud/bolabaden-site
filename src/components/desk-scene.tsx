...
export function DeskScene() {
  ...
  return (
    <>
      ...
      {/* Scoreboard, manual, and sticky notes get `display: none` below
          640px (removing them from the accessibility tree, not just
          hiding them visually) -- this always-visible block keeps their
          content reachable on mobile instead of silently dropping it. */}
      <div className="command-desk-mobile-summary sm:hidden">
        <p>Signal strength: Strong</p>
        <p>Field manual: on the desk</p>
        <p>Sticky notes: &ldquo;fix later&rdquo;, &ldquo;works now&rdquo;</p>
      </div>
    </>
  );
}
