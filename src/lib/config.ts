...
export const config = {
  ...
  HOME_SHOWCASE_ITEMS: envJson<ShowcaseItem[]>(
    ...
    [
      ...
      {
        id: "showcase-quiet-room",
        title: "XP Desk",
        description:
          "A nostalgic desktop is waiting behind a calmer doorway.",
        type: "link",
        href: "/play",
  ...
  PLAY_PAGE_TITLE: envString("NEXT_PUBLIC_PLAY_PAGE_TITLE", "XP Desk"),
  PLAY_PAGE_DESCRIPTION: envString(
    "NEXT_PUBLIC_PLAY_PAGE_DESCRIPTION",
    "A Windows 2000 and XP-era desktop shell with backend-authored state, BBS routes, and a hidden vault.",
  ),
